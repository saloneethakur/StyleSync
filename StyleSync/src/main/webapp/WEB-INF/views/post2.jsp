        ...
        <main class="content">
            <div class="container mt-5 mb-5">
                <div class="row">
                  ...
                  <div class="post-card">
                    <div class="user-info">
                        <img src="/assets/images/boy.jpg" alt="User Profile Picture">
                        <span class="username">Rajesh Jain</span>
                    </div>
                    <div class="post-title">"Looking for the perfect trousers to match this shirt!"</div>
                    <div class="post-description">"I've fallen in love with this stylish shirt. Now, I need some help finding the ideal trousers to complete the look. . Share your recommendations below!"</div>
 	                    <img src="/assets/images/shirt.jpg" alt="Post Image" class="post-image">
 	                    <div class="post-actions">
                        <div class="studio-actions">
                            <button style="text-decoration:none; color:#f13ab1" ><i class="fa-solid fa-thumbs-up"></i>0</button>
                            <button style="text-decoration:none; color:#f13ab1" ><i class="fa-solid fa-share"></i>0</button>
							<button style="text-decoration:none; color:#f13ab1"><i class="fa-solid fa-comment"></i></a>0</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="post-card">
                    ...
                    <div class="post-actions">
                         <div class="studio-actions">
                            <button style="text-decoration:none; color:#f13ab1" ><i class="fa-solid fa-thumbs-up"></i>10</button>
                            <button style="text-decoration:none; color:#f13ab1" ><i class="fa-solid fa-share"></i>12</button>
                            <button style="text-decoration:none; color:#f13ab1"><i class="fa-solid fa-comment"></i></a>100</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
